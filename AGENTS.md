...
├── xmake.lua              # Root workspace: Peanut + RayTracing + CUDA/OptiX/ISPC config
...
- **Peanut submodule** — upstream fork: `https://github.com/Cle2ment/Peanut`; vendor deps pinned to tested commits
